                ...
                <div class="author-content">
                  <div class="author-header p">
                    ...
                    <h5 class="author-title" style={{ color: "#0a3dab" }}>
                      <strong>
                        Placement details for the Batch 2017 – 2019 (Placements
                        in progress at IIIT-H and JNTU-H )
                      </strong>
                    </h5>
                    <ol list-type-position="inside">
                      <li>
                        No. of Students Registered for the Placements at IIITH,
                        JNTUH, JNTUK & SVU - 203
                      </li>
                    ...
                    <p>
                      ...
                      Software Solutions, Trade Vigil, Inside View, ZOHO, Saven
                      Technologies, Gramener, CDAC, Semantic Bits,Teradata,
                      Progress, Gathi Analytics, Mathworks, Mutual Mobile,IBM
                      Global Business Services, Host Analytics, MedPlus, HSBC,
                      American Express, GE India, AVI Network, EPAM, Innominds.
                    </p>
                    ...
                    <p>
                      ...
                      placement activity. Major companies that visited MSIT and
                      packages offered from 29 lakhs to 3.5 lakhs per annum.
                    </p>
