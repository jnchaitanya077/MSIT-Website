                ...
                <div class="author-block">
                  <div class="author-content">
                    <div class="author-header p">
                      ...
                      <strong>Placement details for the Batch 2017 – 2019 (Placements in progress at IIIT-H and JNTU-H )</strong>
                      </h5>
                      <ol list-type-position="inside">
										    <li>No. of Students Registered for the Placements at IIITH, JNTUH, JNTUK & SVU - 203</li>
                      ...
                      <div className="container">
                        <table className="table" style={{ backgroundColor: "#e3f2fd" }}>
                          <tbody>
                            <tr>
                              <td>
                              No.of students registered for placements
                              </td>
                              <td>{IIITH_REG}</td>
                              <td>{JNTUH_REG}</td>
                              <td>{JNTUK_REG}</td>
                      ...
                      <p>
                        MSIT programme adds great value to its students' career path and this is reflected in the
                        placements as it produces "employable students". Students can avail themselves of the
                        placement opportunities in their respective Learning Centers. CIHL also helps in the 
                        placement activity. Major companies that visited MSIT and packages offered from 29 lakhs 
                        to 3.5 lakhs per annum.
                      </p>
                      <img src={Companies}  className="center2"/><br/><br/>
                    </div>
                </div>
                </div>
                </div>
