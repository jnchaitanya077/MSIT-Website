        ...
        <div className="row main-body mt-5 mb-5">
          ...
          <div className="col-lg-8 ml-4">
            ...
            <p className="general-text">
              ...
              Currently there are about eight MSITians working as interns and
              two full time employees at CA. The company is eager to participate
              in the learning by doing model of MSIT and contribute in
              developing the course content for Storage Technologies.
            </p>
          </div>
        </div>
        ...
        <div className="row main-body mt-5 mb-5">
          ...
          <div className="col-lg-8 ml-4">
            ...
            <p className="general-text">
              ...
              a consortium of universities with the support of State government
              of Andhra Pradesh and Telangana. Through this partnership,
              Gramener is collaborating to create course content, design
              curriculum as per industry standards and also have joint
