...
class App extends React.Component {
  ...
  render() {
    return (
      <div id="top">
        <HeaderTitle name="FAQ's" element={this.props.element} />
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <p>
            ...
            <ol list-type-position="inside">
              <li>
                MSIT division, International Institute of Information
                Technology, Hyderabad (160 Seats)
              </li>
              <li>
              ...
              <li>
                College of Engineering, Jawaharlal Nehru Technological
                University, Kakinada, (50 Seats)
              </li>
              <li>
                College of Engineering, Jawaharlal Nehru Technological
                University, Anatapur, (50 Seats)
              </li>
            </ol>
            <strong>2. How Do I directly apply for stage II?</strong>
            <br />
            If you have acceptable GRE and TOEFL or IELTS scores, you can
            mention your scores and apply online. You would be sent a hall
            ticket for Counselling in the Second Stage.
            <br />
            <br />
            ...
            <br />
            <strong>Stage I:</strong> 2-yr MSIT Graduate Aptitude Test (GAT)
            These are computer based tests.
            <br />
            ...
            <br />
            Yes. You can apply online for General Entrance Test(i.e. GAT) and
            also can take walkin.
            <br />
            <br />
            <strong>
            ...
            <br />
            Yes. The MSIT degree is issued by an university, and is recognized
            by them.
            <br />
            <br />
            <strong>
            ...
            <br />
            You would be given a rank prior to the counselling. You can choose
            the seat depend on the availability of seats in that center during
            the counselling.
            <br />
            <br />
            <strong>
            ...
            <br />
            Yes. The TA and internships would be offered in the second year
            based on the performance of the student in the first year.
            <br />
            <br />
            ...
            Learning Center. As placements will be provided for other courses,
            so also for this course. Along with this, CIHL also has a seperate
