          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
              ...
              <h5 class="author-title">
                <strong>
                  Placement details for the Batch 2017 – 2019 (Placements in
                  progress at IIIT-H and JNTU-H )
                </strong>
              </h5>
              <ol list-type-position="inside">
                <li>
                  No. of Students Registered for the Placements at IIITH, JNTUH,
                  JNTUK & SVU - 203
                </li>
              ...
              <p className="general-text">
                Amazon, Apple India Pvt. Ltd., IBM ISL, Huawei Technologies
                India Pvt. Ltd., TechMojo, Tata Consultancy Services, Value
                Momentum, Nutanix Technologies, Johnson Controls, GE Digital,
                PayTM, MAQ Software, Dupont, F5 Software Solutions, Trade Vigil,
                Inside View, ZOHO, Saven Technologies, Gramener, CDAC, Semantic
                Bits,Teradata, Progress, Gathi Analytics, Mathworks, Mutual
              ...
              <p className="general-text">
                MSIT programme adds great value to its students' career path and
                this is reflected in the placements as it produces "employable
                students". Students can avail themselves of the placement
                opportunities in their respective Learning Centers. CIHL also
