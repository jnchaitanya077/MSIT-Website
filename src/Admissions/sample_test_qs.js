              ...
              <div class="author-block">
                <div class="author-content">
                  <div class="author-header p">
                    ...
                    <span className="med-font">
                      ...
                      part of the sentence is missing. The sentence is followed
                      by five answer choices that consist of words. Select the
                      answer choice that best completes the sentence.{" "}
                    </span>{" "}
                    <br />
                    <br />
                    <span className="med-font">
                      ...
                      proposed indemnity policy is to __________ the burden of
                      medical costs, thereby removing what is for many people
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a major __________
                      medical care.{" "}
                    </span>{" "}
                    <br />
                ...
                <div class="author-content">
                  <div class="author-header p">
                    ...
                    <span className="med-font">
                      ...
                      of questions followed by answer choices. Read the passage
                      carefully. Select the right answer to each question from
                      the options provided. Answers are based on the contents of
                      the passage or on what the author implies in the passage.{" "}
                    </span>{" "}
                    <br />
                    <br />
                    <h6 style={{ color: "#0a3dab" }}>
                    ...
                    <span className="med-font">
                      {" "}
                      Socialism differs from Communism in that is a tendency not
                      a body of dogmas. There is no authoritative statement of
                      its ideals upon which all are agreed and it is possible
                      for many who do not call themselves sociologists to
                      sympathize with some of their principles. Whether under
                      such conditions the theories can be put to practise is a
                      policy of advocating the ownership and control of the
                      means of production. It seeks to balance a rigid
                      discipline in what affects the individual himself. It
                      admits Mill’s distinction between self – seeking and other
                      – regarding actions, but it claims that Mill’s miss –
                      stated the problem by under estimating the part played by
                      economists. The main aim of Socialism is the creation of
                      equality, because it holds that liberty is not worth
                    ...
                    <span className="med-font">
                      <p>
                        ...
                        social well-being must necessarily be mutually exclusive
                        <br />
                ...
                <div class="author-content">
                  <div class="author-header p">
                    ...
                    <span className="med-font">
                      {" "}
                      Given below is a word. Each word is followed by five words
                      or phrases. Choose the word that is most nearly opposite
                      in meaning to the word in capital letters. Since some of
                      the questions require you to distinguish fine shades of
                      meaning, be sure to consider all the choices before
                ...
                <div class="author-content">
                  <div class="author-header p">
                    ...
                    <span className="med-font">
                      ...
                      followed by a set of five options. Read the problem
                    ...
                    <span className="med-font">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. In an examination,
                      70% students passed in Science and 65% passed in Social
                      Studies. 27% of the students failed in both the subjects.
                      If only 292 students passed in both the subjects, the
                      total number of students appearing for the examination was{" "}
                    </span>{" "}
                    <br />
                    <p>
                ...
                <div class="author-content">
                  <div class="author-header p">
                    ...
                    <span className="med-font">
                      ...
                      appears in both columns, it represents the same thing each
                      time.{" "}
                    </span>{" "}
                    <br />
                    <br />
                    ...
                    <span className="med-font">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4. Quantity A =
                      (1/25)1/2 + (1/144)1/2 Quantity B = [(1/25) + (1/144)]1/2{" "}
                    </span>{" "}
                    <br />
                    <p>
                      &emsp;&emsp;&emsp;&nbsp;a. Quantity A is greater <br />
                    ...
                    <span className="med-font">
                      ...
                      subsets of ‘n’. The values of ‘m’ and ‘n’are respectively,{" "}
                    </span>{" "}
                    <br />
                    <p>
                    ...
                    <span className="med-font">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;7. Let L denote the
                      set of all straight lines in a plane. Let a relation R be
                      defined by a R b Û a ^ b for a,b Î L. The relation R is{" "}
                    </span>{" "}
                    <br />
                    <p>
                    ...
                    <span className="med-font">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;8. If a function F is
                      such that F ( 0 ) = 2, F (1) = 3 and F ( x + 2 ) = 2 F (x)
                      – F ( x + 1 ) for x ³ 0, then F (5) is equal to{" "}
                    </span>{" "}
                    <br />
                    <p>
                ...
                <div class="author-content">
                  <div class="author-header p">
                    ...
                    <span className="med-font">
                      ...
                      passage or a set of conditions. Sometimes, in answering
                      these questions, you might want to make a table or
                      diagram. For each question, choose the best answer from
                    ...
                    <span className="med-font">
                      ...
                      Industry must continue. This is not a handout but rather a
                      system of moderate cash subsidies to enable our
                      beleaguered industry to withstand the shocks of rising
                      costs and high interest rates, and so continue to provide
                      useful employment to thousands of Indian citizens.{" "}
                    </span>{" "}
                    <br />
                    <span className="med-font">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. The major logical
                    ...
                    <br />
                    <p>
                      &emsp;&emsp;&emsp;&nbsp;a. The speaker is arguing against
                      his own personal interest. <br />
                      &emsp;&emsp;&emsp;&nbsp;b. It makes no attempt to explain
                      the ultimate causes of rising costs and high interest
                      rates.
                      <br />
                      ...
                      significance of the Widget Industry for the Indian economy
                      as a whole.
                      <br />
                    ...
                    <span className="med-font">
                      ...
                      only by six-foot-high dividers. Therefore, voices, sounds,
                      and cigarette smoke readily pass from each office to those
                      on either side.{" "}
                    </span>{" "}
                    <br />
                    <br />
                    <span className="med-font">
                      ...
                      <br />
                      Sneha, the senior employee, is entitled to Office 5, which
                    ...
                    <span className="med-font">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4. The three employees
                      who smoke should be placed on Offices{" "}
                    </span>{" "}
                    <br />
                    <p>
                    ...
                    <span className="med-font">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5. Which of the
                      following events, occurring one month after the assignment
                      of offices, would be most likely to lead to a request for
                      a change in office assignment by one or more employees?{" "}
                    </span>{" "}
                    <br />
                    <p>
