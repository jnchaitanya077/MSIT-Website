...
const info = [
  ...
  },
  {
    ...
    sub:
      "For example, if a student is being offered a course on data structures, he would be asked to work on a project like ‘Mini Google search engine’ which would enable them to understand the various algorithms involved and assimilate the underlying concepts to develop this project. Another simulation is, for the Networks course they need to come up with a File Protocol and similarly for the Database course ‘Airline Reservation System’. In addition to this, Concept tests, Programming Concepts and Quizzes are held. Therefore, MSIT students gain hands-on experience while conditioning themselves, and looking for innovative learning solutions.",
  },
  {
    id: 3,
    idName: "SoftSkills",
  ...
  },
  {
    ...
    body:
      "State of the Art Infrastructure: The students use laptops for performing their tasks, oriented towards their project work and a well-established wired and wireless network are made available 24x7. High end communication mechanisms are used for collaborating with globally distributed teams across learning centers.",
    sub:
      "We will be providing high band-width internet connectivity, 24x7 lab facility, expert faculty.",
  },
  {
    id: 5,
