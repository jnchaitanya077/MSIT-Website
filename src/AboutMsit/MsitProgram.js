...
<div>
    ...
    <button type="button" className="btn btn-outline-secondary" style={{marginTop: "15px", marginBottom: "40px", backgroundColor: "red", padding: "10px 60px", fontSize: "larger"}} ><a href="CoursesAndStructure.html"><h4 style={{ color: "white", fontSize: "16px"}}>Courses And Structure</h4></a></button>
