...
function App(){    
    return(
        <div>
            ...
            <div className="container about-MsitProgram Justify-content-center" style={{paddingTop: "40px"}}>
                ...
                <div className="col news" id = "MsitProgram" style = {{height:"auto", padding:"40px" }}>
                    ...
                    <img src={MsitAdv} style={{width: "38%", float:"right", paddingLeft:"2%"}}/>
                    ...
                    <div className="col news" style={{height:"auto", width:"500px" , padding:"2%", marginTop:"2%"}}>
                        <ul>
