    ...
    <div>
      ...
      <div className="newsLayout">
        <div className="shadows" id="charter">
          ...
          <p>
            To prepare very high quality IT professionals for a global market by
            grooming them in IT and Soft Skills.
          </p>
          <p>
            To enable them to accept opportunities in a framework of
            professionally sound and quality conscious organizations, as well as
            to take up entrepreneurial ventures.
          </p>
          <p>
            To develop their sensitivity and capability to continually respond
            to changing technology and working environments, by using an 'active
            learning' approach.
          </p>
          <p>
            To provide an opportunity not only to IT professionals but also to
            professionals and experts from non-IT domains to acquire a thorough
            knowledge of IT concepts and the capacity to swiftly translate this
            knowledge into services in their respective domains.
          </p>
        </div>
        <div
        ...
        >
          ...
          <p>
            MSIT aims to produce skilled Professionals who have knowledge of the
            core principles underlying information technology and an
          ...
          <p>
            ...
            Institutions of Higher Learning” (CIHL), formed by the Universities.
          </p>
          <p>
            ...
            International Institute of Information Technology (IIIT), College of
            Engineering, Osmania University (OU), Hyderabad and School of
          ...
          <p>
            ...
            Security as domain specializations are offered for the first time in
            the states (AP & Telangana) only in MSIT. Besides these, the course
            also offers specializations in Software Engineering and E-commerce
            which have very high demand in the current software industry.
          </p>
          <h5>
            Eligibility :{" "}
