...
const learningCenters = [
  ...
  },
  {
    ...
    body:
      "Sri Venkateswara University, Tirupati (SVU), is established in 1954 in the world famous holy temple town of Tirupati on the sprawling campus of 1000 acres. Teaching, research and extension activities in different subjects have been emphasized by the University right from its inception. Visit us ",
  },
];
      ...
      <div>
        ...
        <div className="newsLayout">
          ...
          <div className="col-12" id="para">
            <div className="shadows mb-3" style={{ height: "auto" }}>
              <h3>Certification</h3>
              <p>
