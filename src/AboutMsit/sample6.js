    ...
    return(
        <div>
            ...
            <div className="container about-MsitProgram Justify-content-center" style={{paddingTop: "40px", paddingBottom:"40px"}}>
                <div className="col news" style = {{height:"910px"}}>
                <div className="row profile-row">
                    ...
                    {/* <!-- image column--> */}
                    <div className="col-4">
                    <div  className="col news" style={{height:"400px",width:"330px", paddingTop:"1%", paddingLeft:"1%", paddingRight:"1%", paddingBottom:"1%"}}>
                        {/* <div  className="col news" style={{height:"400px",width:"350px", paddingTop:"1%", paddingLeft:"1%", paddingRight:"1%", paddingBottom:"1%"}}> */}
                            ...
                            <img src={MsitAdv} alt="" className="alignright" style={{width: "310px", height: "393px"}}/>
                        </div>
