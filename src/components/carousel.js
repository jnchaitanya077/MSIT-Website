      ...
      >
        <div className="carousel-inner">
          <div className="carousel-item active c-item" data-pause="hover">
            <img src={slider1} className="d-block" alt="slider-image" />
          </div>
          <div className="carousel-item c-item">
            <img src={slider_2} className="d-block" alt="slider-image" />
          </div>
          <div className="carousel-item c-item">
            <img src={slider_3} className="d-block" alt="slider-image" />
          </div>
          <div className="carousel-item c-item">
            <img src={slider_4} className="d-block" alt="slider-image" />
          </div>
        </div>
        <a
